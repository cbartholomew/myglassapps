...
///- Items that have the bundleId in question AND isBundleCover set to false</summary>
        ...
        /// <summary>When true, indicates this item is pinned, which means it&apos;s grouped alongside &quot;active&quot; items like navigation and hangouts, on the opposite side of the home screen from historical (non-pinned) timeline items.</summary>
        ...
        /// <summary>The speakable version of the content of this item. Along with the READ_ALOUD menu item, use this field to provide text that would be clearer when read aloud, or to provide extended information to what is displayed visually on Glass.</summary>
        ...
        /// <summary>HTML content for this item. If both text and html are provided for an item, the html will be rendered in the timeline.</summary>
    ...
    public class TimelineResource {
        ...
        public class AttachmentsResource {
            ...
            public class InsertMediaUpload : Google.Apis.Upload.ResumableUpload<string, Google.Apis.Mirror.v1.Data.Attachment> {
                ...
                public InsertMediaUpload(Google.Apis.Services.IClientService service, string itemId, System.IO.Stream stream, string contentType) : 
                        base(service.BaseUri, "/upload/mirror/v1/timeline/{itemId}/attachments", "POST", stream, contentType) {
        ...
        public class InsertMediaUpload : Google.Apis.Upload.ResumableUpload<Google.Apis.Mirror.v1.Data.TimelineItem, Google.Apis.Mirror.v1.Data.TimelineItem> {
            ...
            public InsertMediaUpload(Google.Apis.Services.IClientService service, Google.Apis.Mirror.v1.Data.TimelineItem body, System.IO.Stream stream, string contentType) : 
                    base(service.BaseUri, "/upload/mirror/v1/timeline", "POST", stream, contentType) {
                this.Body = body;
                this.Authenticator = service.Authenticator;
            }
        ...
        public class UpdateMediaUpload : Google.Apis.Upload.ResumableUpload<Google.Apis.Mirror.v1.Data.TimelineItem, Google.Apis.Mirror.v1.Data.TimelineItem> {
            ...
            public UpdateMediaUpload(Google.Apis.Services.IClientService service, Google.Apis.Mirror.v1.Data.TimelineItem body, string id, System.IO.Stream stream, string contentType) : 
                    base(service.BaseUri, "/upload/mirror/v1/timeline/{id}", "PUT", stream, contentType) {
                this.Body = body;
                this.Authenticator = service.Authenticator;
                this._id = id;
            }
